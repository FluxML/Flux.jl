...
function load()
    isfile(deps("sentiment.zip")) && return nothing
    @info "Downloading sentiment treebank dataset"
    return download_and_verify(
        "https://cache.julialang.org/https://nlp.stanford.edu/sentiment/trainDevTestTrees_PTB.zip",
        deps("sentiment.zip"),
        "5c613a4f673fc74097d523a2c83f38e0cc462984d847b82c7aaf36b01cbbbfcc",
    )
end
