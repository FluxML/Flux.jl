...
@testset "conv output dimensions" begin
  ...
  m = MaxPool((2, 2))
  @test Flux.outdims(m, (10, 10, 3)) == (5, 5, 3)
  m = MaxPool((2, 2); stride = 1)
  @test Flux.outdims(m, (5, 5, 4)) == (4, 4, 4)
  m = MaxPool((2, 2); stride = 2, pad = 3)
  @test Flux.outdims(m, (5, 5, 2)) == (5, 5, 2)
