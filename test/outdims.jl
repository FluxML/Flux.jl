@testset "basic" begin
  ...
  @test outdims(m, (10, 10, 3, 1)) == (6, 6, 32, 1)

  m = Dense(10, 5)
  @test_throws DimensionMismatch outdims(m, (5, 2)) == (5, 1)
  @test outdims(m, (10,); padbatch=true) == (5, 1)

  m = Chain(Dense(10, 8, σ), Dense(8, 5), Dense(5, 2))
  @test outdims(m, (10,); padbatch=true) == (2, 1)
...
@testset "activations" begin
  @testset for f in [celu, elu, gelu, hardsigmoid, hardtanh,
    ...
    @test outdims(Dense(10, 5, f), (10, 1)) == (5, 1)
  end
end
...
@testset "conv" begin
  ...
  @test outdims(m, (10, 10, 3, 1)) == (2, 2, 3, 1)

  m = AdaptiveMeanPool((2, 2))
  @test outdims(m, (10, 10, 3, 1)) == (2, 2, 3, 1)

  m = GlobalMaxPool()
  @test outdims(m, (10, 10, 3, 1)) == (1, 1, 3, 1)
...
@testset "normalisation" begin
  ...
  @test outdims(m, (10,); padbatch=true) == (10, 1)
  ...
  @test outdims(m, (32, 32, 3); padbatch=true) == (32, 32, 3, 16)
  ...
  if VERSION >= v"1.1"
    ...
    @test outdims(m, (32, 32, 16); padbatch=true) == (32, 32, 16, 16)
  end
end
